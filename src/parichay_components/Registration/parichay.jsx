  ...
  return (
    ...
    <div className='esummit-registration'>
      ...
      <div className='registration-form'>
        ...
        <br />
          <p> 
          Join us for an exhilarating intellectual showdown at the speaker sessionb, hosted by E-cell of VIT Bhopal. <br />
          ...
          Event Date: 11 October 2024, From --.-- am to --.-- pm<br />

          Event Venue: Auditorium 1<br />

          Team Strength – 4 Members<br />

          Participation Fees: Rs. --/-<br />
